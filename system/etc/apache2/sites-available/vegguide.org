...
<VirtualHost _default_:80>
    ...
    RewriteRule   ^/(search|printable|location_suggestion|promo_cards).html    -                      [G,L]
    ...
    AliasMatch   (/\d+)?/css           /usr/local/share/vegguide/css
    AliasMatch   (/\d+)?/images        /usr/local/share/vegguide/images
    ...
    AliasMatch   (/\d+)?/js            /var/lib/vegguide/js
