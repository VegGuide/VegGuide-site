...
<VirtualHost _default_>
    <IfDefine !Testing>
        ...
        CustomLog /var/log/apache2/access.log with_host
    </IfDefine>

    <IfDefine Testing>
        CustomLog /home/autarch/.vegguide/var/log/apache2/access.log combined
    </IfDefine>
    ...
    <IfDefine !Testing>
        ...
        RewriteRule  (.*)                     http://www.vegguide.org$1                                   [R,L,NE]
        RewriteCond  %{HTTP_HOST}             ^.*\.regveg\.org
        RewriteRule  (.*)                     http://www.vegguide.org$1                                   [R,L,NE]
    </IfDefine>
    ...
    RewriteRule   !^/404               - [C]
    RewriteRule   !^/crossdomain\.xml  - [C]
    RewriteRule   !^(/\w+)?/css        - [C]
    RewriteRule   !^/entry-images      - [C]
    RewriteRule   !^/user-images       - [C]
    RewriteRule   !^(/\w+)?/images     - [C]
    RewriteRule   !^(/\w+)?/js         - [C]
    ...
    <IfDefine !Testing>
        AliasMatch   (/\w+)?/css/vegguide-combined.css       /var/lib/vegguide/css/vegguide-combined.css
        AliasMatch   (/\w+)?/css(.+)       /usr/local/share/vegguide/css$2
        AliasMatch   (/\w+)?/images(.+)    /usr/local/share/vegguide/images$2
    ...
    <IfDefine Testing>
        AliasMatch   (/\w+)?/css/vegguide-combined.css       /home/autarch/.vegguide/var/lib/css/vegguide-combined.css
        AliasMatch   (/\w+)?/css(.+)       ${PWD}/share/css$2
        AliasMatch   (/\w+)?/images(.+)    ${PWD}/share/images$2
        Alias        /static/rss           /var/cache/vegguide/rss
        Alias        /static               ${PWD}/share/static
        Alias        /w3c                  ${PWD}/share/w3c

        Alias        /robots.txt           ${PWD}/share/static/robots.txt

        Alias        /entry-images         /home/autarch/.vegguide/var/lib/entry-images
        Alias        /user-images          /home/autarch/.vegguide/var/lib/user-images
        AliasMatch   (/\d+)?/js(.+)        /home/autarch/.vegguide/var/lib/js$2
        Alias        /skin-images          /home/autarch/.vegguide/var/lib/skin-images
    </IfDefine>
...
<IfDefine !Testing>
<VirtualHost www.vegguide.org:443>
    SSLEngine on
