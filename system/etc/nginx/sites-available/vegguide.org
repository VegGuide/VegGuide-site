...
server {
    ...
    ssl_certificate     /etc/ssl/certs/www.vegguide.org-chained.crt;
...
server {
    ...
    ssl_certificate     /etc/ssl/certs/lists.vegguide.org-chained.crt;
    ssl_certificate_key /etc/ssl/private/lists.vegguide.org.key;
